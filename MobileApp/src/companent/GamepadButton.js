...
const buttons = {
  default: require('../shared/json/btn-default.json'),
  up: require('../shared/json/btn-up.json'),
  down: require('../shared/json/btn-down.json'),
  left: require('../shared/json/btn-left.json'),
  circle: require('../shared/json/btn-circle.json'),
  triangle: require('../shared/json/btn-triangle.json'),
  cross: require('../shared/json/btn-cross.json'),
  rectangle: require('../shared/json/btn-rectangle.json'),
  right: require('../shared/json/btn-right.json'),
